...
void fillWin(int area, int color) {     // Fill window with specified color
    ...
    for (i=0; i<area; i++) {
        ...
        //WriteSpiData(color);
	//WriteSpiData((unsigned char) (color)); //(unsigned char)((color >> 4) & 0x00FF));
	//WriteSpiData((unsigned char) (color<<4)); //(unsigned char)((color >> 4) & 0x00FF));
	//WriteSpiData((unsigned char) (color<<8)); //(unsigned char)((color >> 4) & 0x00FF));
