...
#define TIMEOUT     	 0x0FFFFF     /* Timeout value */
#define TIMEOUT_READ     0x00FFFF     /* Timeout value */
#define TIMEOUT_WRITE    0x0FFFFF     /* Timeout value */
...
u8 FMI_WaitForLastOperation(vu32 FMI_Bank, u32 flash_time_out);
